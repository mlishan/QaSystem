                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <select class="custom-select" id="userrole" name="userrole">
                            <option value="1" <?php echo e($user->userrole == "1" ? 'selected' : ''); ?>>Developer</option>
                            <option value="2" <?php echo e($user->userrole == "2" ? 'selected' : ''); ?>>QA</option>
                            <option value="3" <?php echo e($user->userrole == "3" ? 'selected' : ''); ?>>Superadmin</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <div class="form-group d-flex justify-content-center align-items-center">
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(asset('images/avatar5.png')); ?>" class="img-fluid img-thumbnail" alt="Avatar" id="cimg">
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Documents\ishan\projects\Qa\resources\views/users/edituser.blade.php ENDPATH**/ ?>