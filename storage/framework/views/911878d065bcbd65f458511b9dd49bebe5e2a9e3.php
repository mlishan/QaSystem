    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <img src="<?php echo e(asset('images/34211_green_icon.png')); ?>" class="online-img" alt="online"> <a>
            <small>
                <?php if(Auth::user()->userrole == 3): ?>
                    Superadmin
                <?php elseif(Auth::user()->userrole == 2): ?>
                    QA
                <?php else: ?>
                    Developer
                <?php endif; ?>
...
<?php /**PATH C:\Users\Lenovo\Documents\ishan\projects\Qa\resources\views/navigation/index.blade.php ENDPATH**/ ?>